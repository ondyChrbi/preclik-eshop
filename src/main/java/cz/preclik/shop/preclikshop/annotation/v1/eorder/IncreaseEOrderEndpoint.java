...
@ApiResponses({
        ...
        @ApiResponse(responseCode = "409", description = "Not enough quantity or product is not available on stock", content = @Content(mediaType = MediaType.TEXT_PLAIN_VALUE)),
})
